...
API-backed MVP design. Confirm against the final production backend, billing,
AI, Calendar, analytics, crash reporting, and notification behavior before
publishing.
...
| ------------------------------ | ----------------------------------------------------------------------------- | ------------------------------------------------- | ----------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ |
| Personal info: email address   | Account email, invitation email entered by a user                             | Yes, when accounts/workspace invitations are used | With backend service providers; with app store or email provider only if configured | Account management, authentication, workspace invitations, support.                                    |
...
| Location                       | Precise or approximate location                                               | No                                                | No                                                                                  | Not part of MVP.                                                                                       |
| Photos/videos/audio/files      | User media files                                                              | No                                                | No                                                                                  | Not part of MVP.                                                                                       |
