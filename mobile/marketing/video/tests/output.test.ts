...
describe('output metadata', () => {
  const flagshipRules = {width: 1920, height: 1080, minSeconds: 1, maxSeconds: 115};
  const tiktokRules = {width: 1080, height: 1920, minSeconds: 20, maxSeconds: 30};
  it('accepts the flagship format', () => expect(validateVideoMetadata({width: 1920, height: 1080, fps: 30, durationSeconds: 115, codec: 'h264'}, flagshipRules)).toEqual([]));
