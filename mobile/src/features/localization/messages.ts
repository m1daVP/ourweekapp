export const messages = {
  en: {
    ...
    settings: {
      ...
      participantsIntro:
        'People used for meeting notes, tasks, and agreements. Stored on this device. Account invitations live in Workspace settings.',
  ...
  uk: {
    ...
    settings: {
      ...
      participantsIntro:
        'Люди для нотаток, завдань і домовленостей. Зберігаються на цьому пристрої. Запрошення до дому доступні у налаштуваннях дому.',
  ...
  es: {
    ...
    settings: {
      ...
      participantsIntro:
        'Personas usadas para notas, tareas y acuerdos. Se guardan en este dispositivo. Las invitaciones de cuenta están en los ajustes del espacio.',
