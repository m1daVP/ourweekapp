export const messages = {
  en: {
    ...
    account: {
      ...
      dataRightsHelp:
        'Export your account data or delete the account and OurWeek data stored on this device.',
    ...
    meeting: {
      ...
      ritualTitle: 'Weekly ritual',
      checkInTitle: "Who's here?",
      checkInIntro: 'Tap to check in members joining the ritual today.',
      addGuest: 'Add guest',
  ...
  uk: {
    ...
    meeting: {
      ...
      ritualTitle: 'Щотижневий ритуал',
      checkInTitle: 'Хто тут?',
      checkInIntro:
        'Позначте людей, які долучаються до сьогоднішнього ритуалу.',
      addGuest: 'Додати гостя',
      addToSession: 'Додати до сесії',
  ...
  es: {
    ...
    meeting: {
      ...
      ritualTitle: 'Ritual semanal',
      checkInTitle: '¿Quién está aquí?',
      checkInIntro: 'Toca para marcar a quienes se unen al ritual de hoy.',
      ...
      addToRitual: 'Agregar al ritual',
      startRitual: 'Iniciar ritual',
      ...
      reviewReadyText:
        'Revisa las notas, acciones y acuerdos antes de finalizar.',
      ...
      noAgreedActionsYet: 'Todavía no hay acciones acordadas.',
