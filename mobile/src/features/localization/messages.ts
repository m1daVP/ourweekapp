export const messages = {
  en: {
    ...
    supportDiagnostics: {
      ...
      intro:
        'Check app status and copy a private status report if support asks for it.',
      ...
      backendHelp:
        'Readiness shows the API and database checks reported by the backend.',
      health: 'Health',
      liveness: 'Liveness',
      readiness: 'Readiness',
      database: 'Database',
      ...
      storageHelp:
        'Storage status shows whether local recovery messages are active.',
    ...
    features: {
      ...
      advancedStatistics: {
        ...
        lockedReason: 'Upgrade to see extra household patterns when available.',
      },
    },
    reminders: {
      title: 'OurWeek',
  ...
  uk: {
    ...
    settings: {
      ...
      participantAdded: 'Людину додано.',
      participantUpdated: 'Людину оновлено.',
      participantEnabled: 'Людину показано для нових зустрічей.',
      participantDisabled:
        'Людину приховано для нових зустрічей. Попередні записи збережуть ім’я.',
    ...
    supportDiagnostics: {
      kicker: 'Підтримка',
      title: 'Діагностика підтримки',
      intro:
        'Перевірте стан застосунку й скопіюйте звіт без особистого вмісту, якщо підтримка попросить.',
      appStatus: 'Стан застосунку',
      privacyNote:
        'Діагностика містить лише технічний стан. Нотатки зустрічей, приватні нотатки, завдання, домовленості, токени, квитанції та AI-запити не включаються.',
      environment: 'Середовище',
      backendOrigin: 'Сервер',
      platform: 'Платформа',
      online: 'Онлайн',
      accountState: 'Акаунт',
      ...
      syncHelp:
        'Локальні зміни залишаються збереженими, якщо синхронізація не завершиться.',
      conflicts: 'Конфлікти',
      lastAttempted: 'Остання спроба',
      lastSynced: 'Остання синхронізація',
      backendStatus: 'Стан сервера',
      backendHelp:
        'Готовність зараз показує перевірки API та бази даних, які повертає сервер.',
      health: 'Стан',
      liveness: 'Доступність',
      readiness: 'Готовність',
      database: 'База даних',
      storageStatus: 'Стан сховища',
      storageHelp:
        'Діагностика сховища показує, чи є активні повідомлення про локальне відновлення.',
      storageIssue: 'Потребує уваги',
      storageMessages: 'Повідомлення',
      storageBackups: 'Резервні копії',
      generatedAt: 'Створено',
      shareTitle: 'Поділитися діагностикою',
      shareHelp:
        'Копіюйте лише тоді, коли самі хочете поділитися. Нічого не надсилається автоматично.',
      refresh: 'Оновити стан',
      refreshing: 'Оновлення...',
      copy: 'Копіювати діагностику',
      copied: 'Діагностику скопійовано.',
      copyFallback:
        'Буфер обміну недоступний. Виділіть і скопіюйте діагностику нижче.',
      fallbackLabel: 'JSON діагностики',
      refreshFailed: 'Не вдалося оновити діагностику зараз.',
      yes: 'Так',
      no: 'Ні',
      accountStates: {
        signed_in: 'Увійшли',
        ...
        error: 'Акаунт потребує уваги',
      },
      backendStates: {
        reachable: 'Доступний',
        not_ready: 'Доступний, але не готовий',
  ...
  es: {
    app: {
      ...
      routeTitles: {
        ...
        account: 'Cuenta',
        supportDiagnostics: 'Diagnóstico',
    ...
    supportDiagnostics: {
      ...
      intro:
        'Revisa el estado de la app y copia un informe sin datos personales si soporte lo pide.',
      appStatus: 'Estado de la app',
      privacyNote:
        'El diagnóstico solo incluye estado técnico. No incluye notas de reuniones, notas privadas, tareas, acuerdos, tokens, recibos ni prompts de IA.',
      environment: 'Entorno',
      backendOrigin: 'Servidor',
      platform: 'Plataforma',
      online: 'En línea',
      accountState: 'Cuenta',
      ...
      syncHelp:
        'Los cambios locales siguen guardados si la sincronización no termina.',
      conflicts: 'Conflictos',
      lastAttempted: 'Último intento',
      lastSynced: 'Última sincronización',
      backendStatus: 'Estado del servidor',
      backendHelp:
        'La preparación muestra las revisiones de API y base de datos que expone el servidor.',
      health: 'Estado',
      liveness: 'Actividad',
      ...
      storageHelp:
        'El diagnóstico de almacenamiento muestra si hay avisos locales de recuperación activos.',
      storageIssue: 'Necesita atención',
      storageMessages: 'Mensajes',
      storageBackups: 'Copias',
      generatedAt: 'Generado',
      shareTitle: 'Compartir diagnóstico',
      shareHelp:
        'Cópialo solo si decides compartirlo. Nada se envía automáticamente.',
      refresh: 'Actualizar estado',
      refreshing: 'Actualizando...',
      copy: 'Copiar diagnóstico',
      copied: 'Diagnóstico copiado.',
      copyFallback:
        'El portapapeles no está disponible. Selecciona y copia el diagnóstico de abajo.',
      fallbackLabel: 'JSON de diagnóstico',
      refreshFailed: 'No se pudo actualizar el diagnóstico ahora.',
      yes: 'Sí',
      no: 'No',
      accountStates: {
        signed_in: 'Sesión iniciada',
        guest: 'Sin cuenta',
        loading: 'Revisando cuenta',
        error: 'La cuenta necesita atención',
      },
      backendStates: {
        reachable: 'Disponible',
        not_ready: 'Disponible, no listo',
    ...
    features: {
      ...
      advancedStatistics: {
        ...
        lockedReason:
          'Pasa a Premium para desbloquear información avanzada del hogar cuando esté disponible.',
      },
    },
    reminders: {
      title: 'OurWeek',
