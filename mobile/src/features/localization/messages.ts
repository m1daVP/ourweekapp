export const messages = {
  ...
  uk: {
    ...
    insights: {
      ...
      intervalUnavailable: 'Завершіть дві зустрічі, щоб побачити звичний інтервал.',
      ...
      noRecurringTopics: 'Зафіксуйте тему у двох зустрічах, щоб побачити її тут.',
      meetingCount: '{count} зустрічей',
      viewSource: 'Переглянути джерело',
      insufficientData: 'Додайте більше спільної історії, щоб побачити цю статистику.',
    ...
    features: {
      ...
      advancedStatistics: {
        ...
        lockedReason:
          'Оновіться, щоб відкрити розширені інсайти.',
      },
    },
    reminders: {
      title: 'OurWeek',
  ...
  es: {
    ...
    insights: {
      ...
      intervalUnavailable: 'Completa dos reuniones para ver tu intervalo habitual.',
      ...
      insufficientData: 'Añade más historial compartido para ver esta información.',
